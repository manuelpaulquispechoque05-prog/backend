// CRUD de comentarios anidados a reportes.
// El reporteId llega por req.params (mergeParams en rutas).
// El usuario autenticado viene de req.usuario (middleware auth).
import {
